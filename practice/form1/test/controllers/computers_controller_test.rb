...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference("Computer.count") do
      post computers_url, params: { computer: { cdrom: @computer.cdrom, cpu: @computer.cpu, hdd: @computer.hdd, ram: @computer.ram } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { cdrom: @computer.cdrom, cpu: @computer.cpu, hdd: @computer.hdd, ram: @computer.ram } }
