...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference("Friendship.count") do
      post friendships_url, params: { friendship: { followed_id: @friendship.followed_id, follower_id: @friendship.follower_id, status: @friendship.status } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { followed_id: @friendship.followed_id, follower_id: @friendship.follower_id, status: @friendship.status } }
